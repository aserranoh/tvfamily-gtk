/*
newprofileview.cpp - The view to create a profile.
...
NewProfileView::NewProfileView (ViewControllerInterface& controller):
    View (controller)
{}
...
void NewProfileView::set_data (const ViewSwitchData& data)
{}
