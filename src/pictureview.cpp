/*
pictureview.cpp - The view to change a profile picture.
...
PictureView::PictureView (ViewControllerInterface& controller):
    View (controller)
{}
...
void PictureView::set_data (const ViewSwitchData& data)
{}
